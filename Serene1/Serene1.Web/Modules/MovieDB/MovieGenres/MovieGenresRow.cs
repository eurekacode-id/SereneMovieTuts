...
namespace Serene1.MovieDB.Entities
{
    ...
    public sealed class MovieGenresRow : Row<MovieGenresRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Genre"), NotNull, ForeignKey("[mov].[Genre]", "GenreId"), LeftJoin("jGenre"), TextualField("GenreGenreName")]
        ...
        [DisplayName("Genre Genre Name"), Expression("jGenre.[GenreName]")]
        public String GenreGenreName
        {
            get => fields.GenreGenreName[this];
            set => fields.GenreGenreName[this] = value;
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField GenreGenreName;
        }
    }
}
